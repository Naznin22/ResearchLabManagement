		...
		<div class="site-content">
			...
			<div class="page-head" style=background:url(images/page-head-3.jpg)>
				<div class="container">
					...
					<small>NEMO is hosted at https://github.com/usnistgov/NEMO. The web application is written in the Python programming language and uses the Django web framework. It is system independent (can run on Linux, Windows, or Mac) and does not require special hardware to operate. </small>
				</div>
			</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-4">
								...
								<ol class="circle">
									<li>
										<h3>Modeling and Simulation of Nanofabrication (Archived)</h3>
										<p>The CNST hopes to foster a developer community to collaborate on new features and improvements to NEMO. Source code contributions are welcome via GitHub pull requests. The CNST will compile and evaluate these suggestions, modifying NEMO as needed.</p>
									</li>
									<li>
											<h3>Modeling and Simulation of Nanofabrication (Archived)</h3>
											<p>The CNST hopes to foster a developer community to collaborate on new features and improvements to NEMO. Source code contributions are welcome via GitHub pull requests. The CNST will compile and evaluate these suggestions, modifying NEMO as needed.</p>
