			...
			<main class="main-content">
				<div class="fullwidth-block">
					<div class="container">
						<div class="row">
							<div class="col-md-8">
								<h2 class="section-title">Laboratory Management Web Application Goes Nationwide</h2>
								<p>Making reservations, accessing tools, and maintaining equipment at the CNST’s NanoFab got a lot easier five years ago</p> 
