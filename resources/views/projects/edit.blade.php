...
<body>
    ...
    <div id="wrapper">
        ...
        <div class = "container">
                <a id="projects"> <h3>Edit Research Project</h3></a>
                </div>
<div class="row">
<div class="container">
                {!! Form::open(['action' => array('ProjectsController_admin@update', $id), 'method'=>'POST' ]) !!}

                {{-- <div class = "form-group">
                        {{Form::label('id','Id')}}
                        {{Form::text('id',$project->Project_ID,['class' => 'form-control', 'placeholder' => 'Id'] )}}
                    </div> --}}
                    ...
                    <div class = "form-group" class="col-sm-2">
                            ...
                            {{Form::text('completion',$project->Completion,['class' => 'form-control', 'placeholder' => 'Completion'] )}}
                        </div>
    
                        <div class = "form-group">
                                {{Form::label('budget','Budget')}}
                                {{Form::text('budget',$project->Budget,['class' => 'form-control', 'placeholder' => 'Budget'] )}}
                            </div>
                            <div class = "form-group" class="col-sm-2">
                                {{Form::label('public','Public')}}
                                {{Form::text('public',$project->public,['class' => 'form-control', 'placeholder' => 'Public'] )}}
                            </div>
