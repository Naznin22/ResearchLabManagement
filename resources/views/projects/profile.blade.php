...
<head>
  ...
  <title>Sunny Luthra - Traveller - Free Thinker - Blah Blah</title>
              ...
              <!-- About Tab Data -->
                <div id="about">
                    <section class="clearfix">
                        <div class="g2">
                            <div class="photo">
                                <img src="images/rhea.jpg" alt="Sunny Luthra">
                            </div>
                            <div class="info">
                                <h2>
                                    Naznin Haque
                        ...
                        <div class="contact-info">
                          <div class="g1">
                            <div class="item-box clearfix">
                              ...
                              <div class="item-data">
                                <h3><a href="mailto:sunny@mrova.com">nazninhaque7622@gmail.com</a></h3>
                                <p>Email Address</p>
                              </div>
                            </div>
                          </div>
                          <div class="g1">
                            <div class="item-box clearfix">
                              ...
                              <div class="item-data">
                                <h3><a href="http://fb.me/naznin.rhea">naznin.rhea</a></h3>
                        ...
                        <div class="g2">
                            ...
                            <ul class="no-list work">
                                <li>
                                    ...
                                    </h5><span class="label label-info">2009-2010</span>
                                    <p>
                                ...
                                <li>
                                    ...
                                    </h5><span class="label label-info">2011-2012</span>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sodales urna non odio egestas tempor. Nunc vel vehicula ante.
                                    </p>
                                </li>
                                <li>
                                    <h5>
                                        Being Awesome
                                    </h5><span class="label label-danger">2012-Till Death</span>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sodales urna non odio egestas tempor. Nunc vel vehicula ante.
                                    </p>
                                </li>
                            ...
                            <ul class="no-list work">
                                <li>
                                    ...
                                    </h5><span class="label label-success">2006-2015</span>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sodales urna non odio egestas tempor. Nunc vel vehicula ante.
                                    </p>
                                </li>
                                <li>
                                    ...
                                    </h5><span class="label label-warning">2016-2019</span>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sodales urna non odio egestas tempor. Nunc vel vehicula ante.
                                    </p>
                                </li>
                        ...
                        <div class="g1">
                            <div class="sidebar">
                                ...
                                <div class="meter emerald">
                                    <span style="width: 33.3%"><span>Photoshop</span></span>
                                </div>
                                <div class="meter carrot">
                                    <span style="width: 90%"><span>Illustrator</span></span>
                                </div>
                                <div class="meter wisteria">
                                    <span style="width: 60%"><span>InDesign</span></span>
                                </div>
                                ...
                                <div class="meter emerald">
                                    <span style="width: 53.3%"><span>HTML/CSS</span></span>
                                </div>
                                <div class="meter carrot">
                                    <span style="width: 80%"><span>PHP/MySql</span></span>
                                </div>
                                <div class="meter wisteria">
                                    <span style="width: 95%"><span>jQuery/JavaScript</span></span>
                                </div>
                                <div class="meter sunflower">
                                    <span style="width: 75%"><span>Ruby</span></span>
                                </div>
                                <div class="meter asbestos">
                         ...
                         <div class="sny-icon-box">
                           <div class="sny-icon">
                            ...
                            <div class="sny-icon-content">
                              <h4>My Address</h4>
                              <p>Amir Complex, SUST gate, Akhalia</p>
                            </div>
                         </div>
                       </div>
                       <div class="g1">
                         <div class="sny-icon-box">
                           <div class="sny-icon">
                            ...
                            <div class="sny-icon-content">
                              <h4>Mobile Number</h4>
                              <p>+8801716107622<br/>+8801713423105</p>
                            </div>
                         </div>
                       </div>
                       <div class="g1">
