        ...
        <!-- Left navbar-header -->
                ...
                <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">                        
                                <div class = "container">
                                <a id="add"> <h3>Edit users</h3></a>
                                </div>
                                <div class = "container">
    
                                {!! Form::open(['action' => array('UsersController@update', $id),'method'=>'POST', 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class = "form-group" class="col-sm-2">
                                    ...
                                    <div class = "form-group" class="col-sm-2">
                                        ...
                                        <div class = "form-group" class="col-sm-2">
                                                ...
                                                {{Form::text('admin',$user->admin,['class' => 'form-control', 'placeholder' => 'admin'] )}}
                                            </div>
